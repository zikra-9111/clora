...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    'autofocus':True, 'class':'form-control'}), help_text=password_validation.password_validators_help_text_html())
...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'name':forms.TextInput(attrs={'class':'form-control'}), 'phone':forms.NumberInput(attrs={'class':'form-control'}),'locality':forms.TextInput(attrs={'class':'form-control'}),
